...
class AddressComponent extends BaseComponent {
	constructor() {
		super();
		// this.tencentkey = ['RLHBZ-WMPRP-Q3JDS-V2IQA-JNRFH-EJBHL','RRXBZ-WC6KF-ZQSJT-N2QU7-T5QIT-6KF5X','OHTBZ-7IFRG-JG2QF-IHFUK-XTTK6-VXFBN','Z2BBZ-QBSKJ-DFUFG-FDGT3-4JRYV-JKF5O']
		...
		try {
			...
			if(res.status == 0) {
				...
				res.result.forEach(item => {
                  timevalue = paseInt(item.duration.value) + 1200;
